import { Card, Dropdown, Button, CardBody, DropdownToggle } from 'react-bootstrap';
				...
				<Card>
					<CardBody>
						...
						<div className="mt-3 text-center">
							<Image src={user.avatar} alt="" className="img-thumbnail avatar-lg rounded-circle" />
							<h4>{user.name}</h4>
						...
						<div className="mt-3">
							...
							<p>
								{groups.map((group, index) => {
									return (
										<span key={index.toString()} className="badge badge-success-lighten p-1 font-14 me-1">
											{group}
										</span>
									);
								})}

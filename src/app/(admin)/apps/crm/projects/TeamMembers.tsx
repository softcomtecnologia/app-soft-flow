		...
		<Card>
			...
			<SimpleBar className="card-body py-0" style={{ maxHeight: '308px' }}>
				{(members || []).map((member, index) => {
					return (
						<div className={classNames('d-flex', 'align-items-start', index === 0 ? 'mt-0' : 'mt-3')} key={index.toString()}>
							<Image className="me-3 rounded-circle" src={member.avatar} width="40" alt="" />

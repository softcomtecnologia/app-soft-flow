			...
			<Col>
				...
				<div className="border p-3 mb-3 rounded">
					<Row>
						...
						<Col sm={4} className="text-sm-end mt-3 mt-sm-0">
							<Image src={paypalImg} height="25" alt="paypal-img" />
						</Col>
					</Row>
				</div>
				...
				<div className="border p-3 mb-3 rounded">
					<Row>
						...
						<Col sm={4} className="text-sm-end mt-3 mt-sm-0 d-flex gap-1 justify-content-end">
							<Image src={masterCardImg} height="24" alt="master-card-img" />
							<Image src={discoverImg} height="24" alt="discover-card-img" />
							<Image src={visaCardImg} height="24" alt="visa-card-img" />
							<Image src={stripeImg} height="24" alt="stripe-card-img" />
						</Col>
					</Row>

					<Form onSubmit={() => {}} className="mt-4" schema={paymentSchema}>
						<Row>
							<Col>
								<TextInput
									name="card_number"
						...
						<Row>
							<Col md={6}>
								<TextInput name="name" label="Name on Card" type="text" placeholder="Enter your name" containerClass={'mb-3'} key="notes" />
							</Col>
							<Col md={3}>
								<div className="mb-3">
									<label className="form-label">Expiry date</label>
									<InputMask mask="__/__" replacement={{ _: /\d/ }} placeholder="MM/YY" className="form-control" />
								</div>
							</Col>
							<Col md={3}>
								<div className="mb-3">
									<label className="form-label">CVV</label>
									<InputMask mask="___" replacement={{ _: /\d/ }} placeholder="xxx" className="form-control" />
								</div>
							</Col>
						</Row>
					</Form>
				...
				<div className="border p-3 mb-3 rounded">
					<Row>
						<Col sm={8}>
							...
							<p className="mb-0 ps-3 pt-1">You will be redirected to Payoneer website to complete your purchase securely.</p>
						</Col>
						<Col sm={4} className="text-sm-end mt-3 mt-sm-0">
							<Image src={payoneerImg} height="30" alt="payoneer-img" />
						</Col>
					</Row>
				</div>
				...
				<div className="border p-3 mb-3 rounded">
					<Row>
						...
						<Col sm={4} className="text-sm-end mt-3 mt-sm-0">
							<Image src={cashImg} height="22" alt="cash-img" />
						</Col>
					</Row>
				</div>
				...
				<Row className="mt-4">
					<Col sm={6}>
						<Link href="/apps/ecommerce/shopping-cart" className="btn text-muted d-none d-sm-inline-block btn-link fw-semibold">

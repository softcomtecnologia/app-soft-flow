			...
			<Col>
				...
				<Form onSubmit={() => {}} schema={schema}>
					<Row>
						...
						<Col md={6}>
							<TextInput label="Last Name" type="text" name="lastname" placeholder="Enter your last name" containerClass={'mb-3'} key="lastname" />
						</Col>
					</Row>
					<Row>
						<Col md={6}>
							<TextInput label="Email address" type="email" name="email" placeholder="Enter your email" containerClass={'mb-3'} key="email" />
						</Col>
						<Col md={6}>
					...
					<Row>
						<Col md={12}>
							<TextInput label="Address" type="text" name="address" placeholder="Enter your state" containerClass={'mb-3'} key="address" />
						</Col>
					</Row>
					<Row>
						<Col md={4}>
							<TextInput label="Town / City" type="text" name="towncity" placeholder="Enter your city name" containerClass={'mb-3'} key="towncity" />
						</Col>
						<Col md={4}>
							<TextInput label="State" type="text" name="state" placeholder="Enter your state" containerClass={'mb-3'} key="state" />
						</Col>
						<Col md={4}>
							<TextInput

...
import { Button, ButtonGroup, Card, CardBody, Col, Dropdown, OverlayTrigger, Row, Tooltip } from 'react-bootstrap';
import { ComposeMail, LeftSide } from '../components';
					...
					<div className="page-aside-right">
						...
						<div className="mt-3">
							...
							<div className="d-flex mb-3 mt-1">
								<Image className="d-flex me-2 rounded-circle" src={email.avatar} alt={email.from_name} height="32" />
							...
							<ol>
								...
								<li>
									Do you want to include your item&apos;s or your &apos;s logo on the page? if yes, please send it to me in vector format (Ai or EPS)
								</li>
													...
													<Row className="align-items-center">
														<Col className="col-auto">
															<div className="avatar-sm">
																<span className="avatar-title bg-primary-lighten text-primary rounded">{f.ext}</span>
															</div>
														</Col>

		...
		<Card className="mb-0">
			<CardBody className="p-3">
				...
				<Dropdown className="float-end" align="end">
					<Dropdown.Toggle variant="link" className="text-muted card-drop arrow-none cursor-pointer p-0 shadow-none">
				...
				<p className="mb-0">
					<Image src={task.userAvatar} alt={task.user} className="avatar-xs rounded-circle me-1" />

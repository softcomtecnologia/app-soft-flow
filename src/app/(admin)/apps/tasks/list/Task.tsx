			...
			<CardBody>
				...
				<Row>
					<Col>
						...
						<Row>
							<Col>
								...
								<div className="d-flex">
									<Image src={task.assignee_avatar} alt={task.assigned_to} className="rounded-circle me-2" height="24" />
									<div>
						...
						<Row className="mt-3">
							<Col>
								<ReactQuill id="bubble-editor" theme="bubble" value={editorState} onChange={onEditorStateChange} style={{ height: 135 }} />
							</Col>
						</Row>
										...
										<Row className="align-items-center">
											...
											<Col className="col-auto">
												<OverlayTrigger placement="left" overlay={<Tooltip>Download</Tooltip>}>
													<Link href="" id="btn-download" className="btn btn-link text-muted btn-lg p-0 me-1">
														<i className="uil uil-cloud-download"></i>
													</Link>
												</OverlayTrigger>
												<OverlayTrigger placement="left" overlay={<Tooltip>Delete</Tooltip>}>
													<Link href="" id="btn-Delete" className="btn btn-link text-danger btn-lg p-0">
								...
								{task.comments.map((comment, index) => (
									<React.Fragment key={index.toString()}>
										<div className="d-flex mt-3 p-1">
											<Image src={comment.author_avatar} className="me-2 rounded-circle" height="36" alt={comment.author} />
											<div className="w-100">
												<h5 className="mt-0 mb-0">
													<span className="float-end text-muted font-12">{comment.posted_on}</span>
													{comment.author}
												</h5>
								...
								<div className="border rounded">
									<form className="comment-area-box">
										...
										<div className="p-2 bg-light">
											...
											<div>
												<Link href="" className="btn btn-sm px-1 btn-light">

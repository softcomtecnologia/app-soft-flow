import { Card, CardBody, Dropdown, DropdownItem, DropdownMenu, DropdownToggle, Table } from 'react-bootstrap';
				...
				<Table hover responsive className="table-centered table-nowrap mb-0">
					<tbody>
						<tr>
							<td>
								<div className="d-flex align-items-start">
									<Image className="me-2 rounded-circle" src={avatar2} width="40" alt="" />
									<div>
							...
							<td className="table-action" style={{ width: '50px' }}>
								<Dropdown className="float-end" align="end">
									<DropdownToggle variant="link" className="arrow-none card-drop p-0 shadow-none">
						...
						<tr>
							<td>
								<div className="d-flex align-items-start">
									<Image className="me-2 rounded-circle" src={avatar6} width="40" alt="" />
									<div>
										<h5 className="mt-0 mb-1">
											Anne Simard
						...
						<tr>
							<td>
								<div className="d-flex align-items-start">
									<Image className="me-2 rounded-circle" src={avatar3} width="40" alt="" />
									<div>
										<h5 className="mt-0 mb-1">
											Nicolas Chartier
						...
						<tr>
							<td>
								<div className="d-flex align-items-start">
									<Image className="me-2 rounded-circle" src={avatar4} width="40" alt="" />
									<div>
										<h5 className="mt-0 mb-1">
											Gano Cloutier
						...
						<tr>
							<td>
								<div className="d-flex align-items-start">
									<Image className="me-2 rounded-circle" src={avatar5} width="40" alt="" />
									<div>
										<h5 className="mt-0 mb-1">
											Francis Achin

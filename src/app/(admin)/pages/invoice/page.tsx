...
const InvoicePage = () => {
	...
	const order_date = 'Jan 17, 2018';
	const order_status = 'Paid';
	const order_id = '123456';
	const order_barcode = orderBarcodeImg;
								...
								<Col sm={6}>
									<div className="mt-3 float-sm-end">
										...
										<p className="font-13">
											...
											<span className="float-end">#{order_id}</span>
										</p>
									</div>
								</Col>
							</Row>
							...
							<Row className="mt-4">
								...
								<Col sm={4}>
									<div className="text-sm-end">
										<Image src={order_barcode} alt="" className="img-fluid me-2" />
									</div>
								</Col>
							</Row>
							...
							<Row>
								...
								<Col sm={6}>
									<div className="float-end mt-3 mt-sm-0">
										...
										<p>
											<b>VAT (12.5):</b>
											<span className="float-end">{vat}</span>
										</p>
										<h3>{total} USD</h3>
									</div>

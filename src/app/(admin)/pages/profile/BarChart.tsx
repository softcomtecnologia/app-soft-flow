...
import { Chart as ChartJS, CategoryScale, LinearScale, BarElement, Title, Tooltip, Legend, ChartData, ChartArea, ChartOptions } from 'chart.js';
...
const BarChart = () => {
	...
	// options
	const barChartOpts: ChartOptions<'bar'> = {

...
const About = ({ projects }: AboutProps) => {
	return (
		<>
				...
				<div className="timeline-item">
					...
					<div className="timeline-item-info">
						...
						<p className="font-14">
							...
							<span className="ms-2 font-12">Year: 2010 - 12</span>
						</p>
					...
					{(projects || []).map((project, index) => {
						return (
							<tr key={index.toString()}>
								<td>{project.id}</td>
								<td>
									<Image src={project.clientProfile} alt="" className="me-2 rounded-circle" height="24" />
									{project.client}
								</td>
								<td>{project.name}</td>

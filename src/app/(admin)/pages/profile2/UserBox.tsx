...
const UserBox = () => {
	return (
		<Card className="text-center">
			<CardBody>
				<Image src={profileImg} className="rounded-circle avatar-lg img-thumbnail" alt="" />
				...
				<div className="text-start mt-3">
					...
					<p className="text-muted font-13 mb-3">
						Hi I&apos;m Johnathn Deo,has been the industry&apos;s standard dummy text ever since the 1500s, when an unknown printer took a galley of
						type.
					</p>
				...
				<ul className="social-list list-inline mt-3 mb-0">
					<li className="list-inline-item">
						<Link href="" className="social-list-item border-primary text-primary">
					...
					<li className="list-inline-item">
						<Link href="" className="social-list-item border-secondary text-secondary">

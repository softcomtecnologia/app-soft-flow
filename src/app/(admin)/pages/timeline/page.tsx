											...
											<div key={idx} className={`timeline-lg-item ${idx % 2 === 0 ? 'timeline-item-left' : ''}`}>
												<div className="timeline-desk">
													<div className="timeline-box">
														...
														<h4 className="mt-0 mb-1 font-16">{item.title}</h4>
														...
														{item.reactions &&
															(item.reactions || []).map((item, idx) => {
																return (
																	<button key={idx} className="btn btn-sm btn-light me-1">
														...
														{item.user && (
															<div className="d-flex">
																<Image src={item.user.image} alt="Arya S" className="rounded-circle me-2" height="24" />
																<div>

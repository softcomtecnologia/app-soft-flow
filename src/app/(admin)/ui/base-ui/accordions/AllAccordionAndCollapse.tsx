...
import { Row, Col, Card, Accordion, Button, Collapse, useAccordionButton, AccordionContext, CardBody } from 'react-bootstrap';
...
const CustomAccordion1 = ({ item, index }: CustomAccordion1Props) => {
	return (
		<Card className="mb-0">
			<Card.Header>
				<CustomToggle eventKey={String(index)} containerClass="m-0" linkClass="custom-accordion-title d-block pt-2 pb-2">
						...
						<CardBody>
							...
							<p className="text-muted font-14 mb-3">
								...
								<Link
									rel="noreferrer"
									href={{
										pathname: 'https://react-bootstrap-v5.netlify.app/utilities/transitions/',
									}}
									target="_blank"
								>
									here
					...
					<Card>
						<Card.Body>
							...
							<p>
								...
								<Button variant="primary" className="ms-1" onClick={toggleSecond}>
									Toggle second element
								</Button>

								<Button variant="primary" className="ms-1" onClick={toggleBoth}>
				...
				<Col xl={6}>
					<Card>
						<Card.Body>
							...
							<Button color="primary" className="ms-1 mb-3" type="button" onClick={toggleHorizontal}>

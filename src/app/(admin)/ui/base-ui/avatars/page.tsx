...
const RoundedCircle = ({ size }: { size: string }) => {
	return (
		<Col md={4}>
			<Image src={avatar3} alt="" className={classNames('img-fluid', 'rounded-circle', 'avatar-' + size)} />
			<p>
				...
				<Col xxl={6}>
					<Card>
						<CardBody>
							...
							<Row>
								<Col md={3}>
									<Image src={avatar2} alt="" className="img-fluid avatar-xs rounded" />
									<p>
										<code>.avatar-xs</code>
									</p>
									<Image src={avatar3} alt="" className="img-fluid avatar-sm rounded mt-2" />
								...
								<Col md={3}>
									<Image src={avatar4} alt="" className="img-fluid avatar-md rounded" />
									<p>
										<code>.avatar-md</code>
									</p>
								</Col>
								...
								<Col md={3}>
									<Image src={avatar5} alt="" className="img-fluid avatar-lg rounded" />
									<p>
										<code>.avatar-lg</code>
									</p>
								</Col>
								...
								<Col md={3}>
									<Image src={avatar6} alt="" className="img-fluid avatar-xl rounded" />
									<p className="mb-0">
										<code>.avatar-xl</code>
									</p>
								</Col>
				...
				<Col>
					<Card>
						<CardBody>
							...
							<Row>
								<Col sm={2}>
									<Image src={img1} alt="" className="img-fluid rounded" width="200" />
									<p className="mb-0">
										<code>.rounded</code>
									</p>
								</Col>
								...
								<Col sm={2} className="text-center">
									<Image src={avatar6} alt="" className="img-fluid rounded" width="120" />
									<p className="mb-0">
										<code>.rounded</code>
									</p>
								</Col>
								...
								<Col sm={2} className="text-center">
									<Image src={avatar7} alt="" className="img-fluid rounded-circle" width="120" />
									<p className="mb-0">
								...
								<Col sm={2}>
									<Image src={img2} alt="" className="img-fluid img-thumbnail" width="200" />
									<p className="mb-0">
								...
								<Col sm={2}>
									<Image src={avatar8} alt="" className="img-fluid rounded-circle img-thumbnail" width="120" />
									<p className="mb-0">

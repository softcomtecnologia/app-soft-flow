...
import { Button, ButtonGroup, Card, CardBody, Col, DropdownButton, DropdownItem, Row } from 'react-bootstrap';
		...
		<Card>
			<CardBody>
				...
				<div className="button-list d-flex flex-wrap gap-2">
					{extendedColorVariants.map((variant, index) => {
						return (
							<Button key={index.toString()} variant={variant} className="btn-rounded">
								{toSentenceCase(variant)}
							</Button>
						);
					})}
		...
		<Card>
			<CardBody>
				...
				<div className="button-list d-flex flex-wrap gap-2">
					{extendedColorVariants.map((variant, index) => {
						return (
							<Button key={index.toString()} variant={'outline-' + variant} className="btn-rounded">
								{toSentenceCase(variant)}
							</Button>
						);
					})}

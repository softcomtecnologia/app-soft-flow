...
export const metadata: Metadata = { title: 'Embed Videos' };
					...
					<Card>
						<CardBody>
							...
							<div className="ratio ratio-21x9">
								<iframe src="https://www.youtube.com/embed/PrUxWZiQfy4?autohide=0&showinfo=0&controls=0" title="iframe"></iframe>
							</div>
						</CardBody>
					</Card>

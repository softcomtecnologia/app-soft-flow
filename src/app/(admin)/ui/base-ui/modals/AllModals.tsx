				...
				<Modal show={signUpModal} onHide={toggleSignUp}>
					<Modal.Body>
						<div className="text-center mt-2 mb-4">
							<Link href="">
								<span>
									<Image src={logodark} alt="" height="18" />
								</span>
							</Link>
						</div>
		...
		<Card>
			<Card.Body>
				...
				<p className="text-muted">
					...
					<code>modal-top</code>,<code>modal-bottom</code>, <code>modal-dialog-centered</code>
					respectively.
				</p>
		...
		<Card>
			<Card.Body>
				...
				<Modal show={isOpen} onHide={toggleModal}>
					<Modal.Header onHide={toggleModal} closeButton className={classNames('modal-colored-header', 'bg-' + className)}>
	...
	return (
		<Card>
			<Card.Body>
				...
				<p className="sub-header">Display a series of modals one by one to guide your users on multiple aspects or take step wise input.</p>

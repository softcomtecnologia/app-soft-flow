...
import { Button, Card, Col, Form, Row, Toast, ToastContainer, ToastContainerProps } from 'react-bootstrap';
	...
	return (
		<Card>
			<Card.Body>
				...
				<p className="text-muted font-14">Push notifications to your visitors with a toast, a lightweight and easily customizable alert message.</p>
					...
					<Col md={6}>
						...
						<div className="p-3">
							<Toast onClose={hide} show={isOpen} autohide>
								<Toast.Header>
									<Image src={logo} alt="brand-logo" height="12" className="me-1" />
				...
				<Row>
					<Col md={6} className="mt-4">
						...
						<p className="text-muted font-14">When you have multiple toasts, we default to vertiaclly stacking them in a readable manner.</p>
						<div className="p-3">
	...
	return (
		<Card>
			<Card.Body>
				...
				<Toast className="d-flex align-items-center mt-4" show={isOpenCustom1} onClose={hideCustom1} delay={3000} autohide>
					<Toast.Body>Hello, world! This is a toast message.</Toast.Body>
					...
					<ToastContainer className="p-3" position={position}>
						<Toast>
							<Toast.Header closeButton={false}>
								<Image src={logo} className="me-1" alt="" height="12" />

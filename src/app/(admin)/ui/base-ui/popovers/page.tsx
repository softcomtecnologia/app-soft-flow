import { Row, Col, Card, Popover, Button, OverlayTrigger, PopoverHeader, PopoverBody, CardBody } from 'react-bootstrap';
	...
	return (
		<Card>
			<CardBody>
				...
				<p className="text-muted font-14">
					Use the <code>trigger</code> attribute with value <code>focus</code> to dismiss popovers on the user&apos;s next click of a different

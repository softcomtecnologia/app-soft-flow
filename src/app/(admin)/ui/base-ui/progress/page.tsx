...
import { Row, Col, Card, ProgressBar, CardBody } from 'react-bootstrap';
	...
	return (
		<Card>
			<CardBody>
				...
				<p className="text-muted font-14">A progressBar bar can be used to show a user how far along he/she is in a process.</p>
		...
		<Card>
			<CardBody>
				...
				<p className="text-muted font-14">
					Add a <code>label</code> prop to show a visible percentage. For low percentages, consider adding a min-width to ensure the label&apos;s text
					is fully visible.
				</p>
	...
	return (
		<Card>
			<CardBody>
				...
				<p className="text-muted font-14">Progress bars use some of the same button and alert classes for consistent styles.</p>
	...
	return (
		<Card>
			<CardBody>
				...
				<p className="text-muted font-14">
					We only set a <code>height</code> value on the <code>ProgressBar</code>, so if you change that value the inner <code>.progress-bar</code>{' '}
					will automatically resize accordingly. Use <code>.progress-sm</code>,<code>.progress-md</code>,<code>.progress-lg</code>,
	...
	return (
		<Card>
			<CardBody>
				...
				<p className="text-muted font-14">
					Add <code>striped</code> to any <code>ProgressBar</code> to apply a stripe via CSS gradient over the progressBar bar’s background color.
				</p>
	...
	return (
		<Card>
			<CardBody>
				...
				<p className="text-muted font-14">
					The striped gradient can also be animated. Add <code>animated</code> to
					<code>ProgressBar</code> to animate the stripes right to left via CSS3 animations.
				</p>

	...
	return (
		<Card>
			<CardBody>
				...
				<p className="text-muted mb-4">You can go for growing spinner as well. While it doesn’t technically spin, it does repeatedly grow!</p>
				<Spinner type="grow" />
			</CardBody>
		</Card>
	);
		...
		<Card>
			<CardBody>
				...
				<p className="text-muted mb-4">
					All standard visual variants are available for both animation styles by setting the <code>variant</code> property.
				</p>

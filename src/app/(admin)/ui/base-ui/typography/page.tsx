					...
					<Card>
						<CardBody>
							...
							<p className="text-muted font-14">
								...
								<code>.h6</code> classes are also available, for when you want to match the font styling of a heading but still want your text to be
								displayed inline.
							</p>
							...
							<p className="text-muted">
								...
								dictum aliquet. Nulla sapien mauris, eleifend et sem ac, commodo dapibus odio. Vivamus pretium nec odio cursus elementum. Suspendisse
					...
					<Card>
						<CardBody>
							...
							<p className="text-muted">
								...
								can optionally add a<code className="highlighter-rouge">.text-truncate</code> class to truncate the text with an ellipsis.
							</p>

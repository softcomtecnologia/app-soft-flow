...
//Stacked Bar Chart
export const StackedBarOps: ApexOptions = {
	chart: {
		height: 380,
		type: 'bar',
		stacked: true,
...
export const FullStackedBarOps: ApexOptions = {
	chart: {
		height: 380,
		type: 'bar',
		stacked: true,
...
//Navigate Bar
export const NavigateBarOps: ApexOptions = {
	chart: {
		height: 380,
		type: 'bar',
		stacked: true,
...
//Reversed Bar Chart
export const ReversedBarOps: ApexOptions = {
	series: [
		{
...
// ImageFillBar Chart
export const ImageFillBarOps: ApexOptions = {
	chart: {
		height: 450,
		type: 'bar',
		toolbar: {
...
export const CustomDataLabelBarOps: ApexOptions = {
	chart: {
		height: 450,
		type: 'bar',
	},
...
//Patterned Bar Chart
export const PatternedBarOps: ApexOptions = {
	chart: {
		height: 380,
		type: 'bar',
		stacked: true,
...
// Bar with Markers
export const MarkersBarOps: ApexOptions = {
	series: [
		{
			name: 'Actual',
			data: [

...
const BasicColumnOps: ApexOptions = {
	chart: {
		height: 396,
		type: 'bar',
		toolbar: {
...
const ColumnWithDataTableOps: ApexOptions = {
	chart: {
		height: 380,
		type: 'bar',
		toolbar: {
...
const StackedColumnOps: ApexOptions = {
	chart: {
		height: 380,
		type: 'bar',
		stacked: true,
...
const FullStackedColumnOps: ApexOptions = {
	chart: {
		height: 380,
		type: 'bar',
		stacked: true,
...
const ColumnwithMarkersOps: ApexOptions = {
	series: [
		{
			name: 'Actual',
			data: [
...
const ColumnGroupLabelOps: ApexOptions = {
	series: [
		{
			name: 'Sales',
			data: [
...
const ColumnWithRotatedlabelsOps: ApexOptions = {
	annotations: {
		points: [
			{
				x: 'Bananas',
...
const ColumnwithnegativevalueOps: ApexOptions = {
	chart: {
		height: 380,
		type: 'bar',
		toolbar: {
...
const DistributedColumnOps: ApexOptions = {
	chart: {
		height: 380,
		type: 'bar',
		toolbar: {
...
const RangeColumnOps: ApexOptions = {
	chart: {
		height: 380,
		type: 'rangeBar',
	},

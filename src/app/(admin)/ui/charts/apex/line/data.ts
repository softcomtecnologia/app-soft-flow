...
export function generateDayWiseTimeSeries(baseval: number, count: number, yrange: { min: number; max: number }): number[][] {
	let i = 0;
	const series: number[][] = [];
	while (i < count) {
		const x = baseval;
...
export const ZoomableTimeseriesOps: ApexOptions = {
	chart: {
		type: 'area',
		stacked: false,
		height: 380,
...
export const LineChartwithAnnotationOps: ApexOptions = {
	annotations: {
		yaxis: [
			{
				y: 8200,
...
export const SyncingChartOps: ApexOptions = {
	chart: {
		height: 200,
		type: 'line',
		id: 'yt',
...
export const SyncingChartOps2: ApexOptions = {
	chart: {
		type: 'line',
		height: 160,
		id: 'fb',
...
export const GradientLineChartOps: ApexOptions = {
	chart: {
		height: 374,
		type: 'line',
		// shadow: {
...
export const MissingChartOps: ApexOptions = {
	chart: {
		height: 380,
		type: 'line',
		zoom: {
...
export const DashedLineChartOps: ApexOptions = {
	chart: {
		height: 380,
		type: 'line',
		zoom: {
...
export const SteplineChartOps: ApexOptions = {
	chart: {
		type: 'line',
		height: 344,
	},
...
export const BrushChartOps: ApexOptions = {
	series: [
		{
			data: data,
		},
...
export const BrushChartOps2: ApexOptions = {
	series: [
		{
			data: data,
		},

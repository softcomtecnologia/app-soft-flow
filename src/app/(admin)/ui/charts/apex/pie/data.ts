...
export const MonochromePieOpt: ApexOptions = {
	chart: {
		height: 320,
		type: 'pie',
	},
...
export const GradientDonutOpt: ApexOptions = {
	chart: {
		height: 320,
		type: 'donut',
	},
...
export const PatternedDonutOpt: ApexOptions = {
	chart: {
		height: 320,
		type: 'donut',
		dropShadow: {
...
export const ImagefillOpt: ApexOptions = {
	chart: {
		height: 320,
		type: 'pie',
	},
...
export const DonutUpdateOpt: ApexOptions = {
	chart: {
		height: 320,
		type: 'donut',
	},

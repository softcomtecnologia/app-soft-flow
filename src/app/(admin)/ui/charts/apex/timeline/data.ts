...
export const DistributedTimelineOps: ApexOptions = {
	series: [
		{
			data: [
				{
...
export const MultiSeriesTimelineOpt: ApexOptions = {
	series: [
		{
			name: 'Bob',
			data: [
...
export const AdvancedTimelineOpt: ApexOptions = {
	series: [
		{
			name: 'Bob',
			data: [
...
export const GroupRowsTimelineOpt: ApexOptions = {
	series: [
		// George Washington
		{

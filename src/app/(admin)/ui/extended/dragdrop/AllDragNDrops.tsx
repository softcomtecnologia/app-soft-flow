		...
		<Card className="mb-0 mt-2">
			<CardBody>
				<div className="d-flex align-itames-start">
					<Image src={item.avatar} alt="" className="me-3 d-none d-sm-block avatar-sm rounded-circle" />
					<div className="w-100">
						...
						<CardBody>
							...
							<Row>
								<Col md={6}>
									<div className="bg-dragula p-2 p-lg-4">
										<h5 className="mt-0">Part 1</h5>
										<ReactSortable group="teamList2" handle=".dragula-handle" list={part1} setList={setPart1} className="py-2">
								...
								<Col md={6}>
									<div className="bg-dragula p-2 p-lg-4">
										<h5 className="mt-0">Part 1</h5>
										<ReactSortable group="teamList2" handle=".dragula-handle" list={part2} setList={setPart2} className="py-2">

                        ...
                        <div className="tab-content">
                            <div className="tab-pane show active" id="default-scroll-preview">
                                <SimpleBar className="card-body py-0 mb-3" style={{maxHeight: 250}}>
                                    ...
                                    custom CSS-styled one without losing
                                    performances. Unlike some popular plugins, SimpleBar doesn&apos;t mimic scroll with
                                    Javascript, causing janks and strange scrolling
                                    behaviours... You keep the awesomeness of native scrolling...with a custom
                                    scrollbar!
                                    <p>
                                        SimpleBar
                                        <strong>does NOT implement a custom scroll behaviour</strong>. It keeps
                                    ...
                                    <p>
                                        ...
                                        you want! Or even have multiple style on the same
                    ...
                    <Card>
                        ...
                        <div className="tab-content">
                            <div className="tab-pane show active" id="left-scroll-preview">
                                <SimpleBar className="card-body py-0 mb-3" data-simplebar-direction="rtl"
                                           style={{maxHeight: 250}}>
                                    SimpleBar does only one thing: replace the browser&apos;s default scrollbar with a
                                    custom CSS-styled one without losing
                                    performances. Unlike some popular plugins, SimpleBar doesn&apos;t mimic scroll with
                    ...
                    <Card>
                        ...
                        <div className="tab-content">
                            <div className="tab-pane show active" id="color-scroll-preview">
                                <SimpleBar className="card-body py-0 mb-3" data-simplebar-primary
                                           style={{maxHeight: 250}}>
                                    SimpleBar does only one thing: replace the browser&apos;s default scrollbar with a
                                    custom CSS-styled one without losing
                                    performances. Unlike some popular plugins, SimpleBar doesn&apos;t mimic scroll with

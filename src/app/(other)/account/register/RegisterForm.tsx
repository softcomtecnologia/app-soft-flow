...
import useRegister from '../register2/useRegister';
	...
	return (
		<AccountWrapper bottomLinks={<BottomLink />}>
			...
			>
				...
				<TextInput label={t('Email Address')} type="text" name="email" placeholder={t('Enter your email')} containerClass="mb-3" />
				<PasswordInput label={t('Password')} name="password1" placeholder={t('Enter password')} containerClass="mb-3" />

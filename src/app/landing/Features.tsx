				...
				<Row>
					<Col lg={12}>
						<div className="text-center">
							...
							<p className="text-muted mt-2">Hyper comes with next generation ui design and have multiple benefits</p>
						</div>
					</Col>
				</Row>
					...
					return item.id % 2 !== 0 ? (
						...
						<Row key={index.toString()} className="pb-3 pt-5 align-items-center">
							<Col lg={6} md={5}>
								...
								<Link href="" className="btn btn-success rounded-pill mt-3">
									Read More <i className="mdi mdi-arrow-right ms-1"></i>
								</Link>
							</Col>

...
const features: Feature[] = [
	{
		...
		image: image1,
		features: ['Projects & Tasks', 'Ecommerce Application Pages', 'Profile, pricing, invoice', 'Login, signup, forget password'],
	},
	{
		id: 2,
		...
		image: image2,
		features: ['Built with latest Bootstrap', 'Extensive use of SCSS variables', ' Well documented and structured code', 'Detailed Documentation'],
	},
];
...
const plans: PricingPlan[] = [
	...
	},
	{
		...
		price: '$599',
		duration: 'License',
		features: ['100 GB Storage', 'Unlimited Bandwidth', '10 Domain', 'Unlimited Users', 'Email Support', '24x7 Support'],
		isRecommended: false,
	},
];

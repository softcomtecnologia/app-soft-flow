...
const ChatForm = ({ onNewMessagesPosted }: { onNewMessagesPosted: (message: NewMessagePosted) => void }) => {
	return (
		<Form name="chat-form" id="chat-form" onSubmit={onNewMessagesPosted} schema={chatMessageSchema} className="needs-validation m-3">
			<Row>
				<Col>
					<TextInput name="message" type="text" className="form-control chat-input" placeholder="Enter your text" key="message" />
				</Col>

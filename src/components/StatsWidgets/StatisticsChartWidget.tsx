...
const StatisticsChartWidget = ({ colors, type, name, data, textClass, bgClass, description, title, stats, trend }: StatisticsChartWidgetProps) => {
	//  default options
		...
		<Card className={classNames('widget-flat', bgClass)}>
			<Card.Body>
				<Row className="align-items-center">
					<Col className="col-6">
						<h5 className={classNames('fw-normal', 'mt-0', 'text-truncate', textClass ? textClass : 'text-muted')} title={description}>
							{title}
						</h5>

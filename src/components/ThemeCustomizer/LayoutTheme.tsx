				...
				<Row>
					<div className="col-4">
						<Form.Check className="card-radio">
							...
							/>
							<Form.Check.Label className="p-0 avatar-md w-100" htmlFor="layout-color-light">
								<div id="sidebar-size">
					...
					<div className="col-4">
						<Form.Check className="card-radio">
							...
							/>
							<Form.Check.Label className="p-0 avatar-md w-100 bg-black" htmlFor="layout-color-dark">
								<div id="sidebar-size">
									<span className="d-flex h-100">
										<span className="flex-shrink-0">

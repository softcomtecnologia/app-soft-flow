			...
			<Row>
				<Form.Check className="col-4">
					<Form.Check className="card-radio">
						...
						/>
						<Form.Check.Label className="p-0 avatar-md w-100" htmlFor="layout-mode-fluid">
							<div id="sidebar-size">
				...
				<Form.Check className="col-4" id="layout-boxed">
					<Form.Check className="card-radio">
						...
						/>
						<Form.Check.Label className="p-0 avatar-md w-100 px-2" htmlFor="layout-mode-boxed">
				...
				<div className="col-4" id="layout-detached">
					<Form.Check className="sidebar-setting card-radio">
						...
						/>
						<Form.Check.Label className="p-0 avatar-md w-100" htmlFor="data-layout-detached">
							<span className="d-flex h-100 flex-column">

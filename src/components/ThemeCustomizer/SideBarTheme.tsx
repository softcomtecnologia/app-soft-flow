			...
			<Row>
				<div className="col-4">
					<Form.Check className="sidebar-setting card-radio">
						...
						/>
						<Form.Check.Label className="p-0 avatar-md w-100" htmlFor="leftbar-color-light">
							<div id="sidebar-size">
				...
				<div className="col-4">
					<Form.Check className="sidebar-setting card-radio">
						...
						/>
						<Form.Check.Label className="p-0 avatar-md w-100" htmlFor="leftbar-color-dark">
							<div id="sidebar-size">
								<span className="d-flex h-100">
									<span className="flex-shrink-0">
				...
				<div className="col-4">
					<Form.Check className="sidebar-setting card-radio">
						...
						/>
						<Form.Check.Label className="p-0 avatar-md w-100" htmlFor="leftbar-color-brand">
							<div id="sidebar-size">
								<span className="d-flex h-100">
									<span className="flex-shrink-0">

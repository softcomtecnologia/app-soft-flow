...
const SideBarType = ({ handleChangeSideBarType, sideBarType, layoutConstants }: LayoutTypeProps) => {
	return (
		<div id="sidebar-size">
			...
			<Row>
				<div className="col-4">
					<Form.Check className="sidebar-setting card-radio">
						...
						/>
						<Form.Check.Label className="p-0 avatar-md w-100" htmlFor="leftbar-size-default">
				...
				<div className="col-4">
					<div className="form-check sidebar-setting card-radio">
						...
						/>
						<Form.Check.Label className="p-0 avatar-md w-100" htmlFor="leftbar-size-compact">
							<span className="d-flex h-100">
								<span className="flex-shrink-0">
				...
				<div className="col-4">
					<div className="form-check sidebar-setting card-radio">
						...
						/>
						<Form.Check.Label className="p-0 avatar-md w-100" htmlFor="leftbar-size-small">
							<span className="d-flex h-100">
								<span className="flex-shrink-0">
				...
				<div className="col-4">
					<div className="form-check sidebar-setting card-radio">
						...
						/>
						<Form.Check.Label className="p-0 avatar-md w-100" htmlFor="leftbar-size-small-hover">
							<span className="d-flex h-100">
								<span className="flex-shrink-0">
									<span className="bg-light d-flex h-100 border-end flex-column" style={{ padding: 2 }}>
										<span className="d-block p-1 bg-dark-lighten rounded mb-1"></span>
				...
				<div className="col-4">
					<div className="form-check sidebar-setting card-radio">
						...
						/>
						<Form.Check.Label className="p-0 avatar-md w-100" htmlFor="leftbar-size-full">
							<span className="d-flex h-100">
								<span className="flex-shrink-0">
									<span className="d-flex h-100 flex-column">
				...
				<div className="col-4">
					<div className="form-check sidebar-setting card-radio">
						...
						/>
						<Form.Check.Label className="p-0 avatar-md w-100" htmlFor="leftbar-size-fullscreen">
							<span className="d-flex h-100">
								<span className="flex-grow-1">
									<span className="d-flex h-100 flex-column">
										<span className="bg-light d-block p-1"></span>

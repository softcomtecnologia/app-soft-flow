			...
			<Row>
				<div className="col-4">
					<Form.Check className="card-radio">
						...
						/>
						<Form.Check.Label className="p-0 avatar-md w-100" htmlFor="topbar-color-light">
							<div id="sidebar-size">
				...
				<div className="col-4">
					<Form.Check className="card-radio">
						...
						/>
						<Form.Check.Label className="p-0 avatar-md w-100" htmlFor="topbar-color-dark">
							<div id="sidebar-size">
								<span className="d-flex h-100">
									<span className="flex-shrink-0">
										<span className="bg-light d-flex h-100 border-end  flex-column p-1 px-2">
				...
				<div className="col-4">
					<Form.Check className="card-radio">
						...
						/>
						<Form.Check.Label className="p-0 avatar-md w-100" htmlFor="topbar-color-brand">
							<div id="sidebar-size">
								<span className="d-flex h-100">
									<span className="flex-shrink-0">
										<span className="bg-light d-flex h-100 border-end  flex-column p-1 px-2">

			...
			<div className="todoapp">
				<CardBody className="p-0">
					...
					{addTodo && (
						<Row>
							<Col>
								<Form name="todo-form" id="todo-form" onSubmit={saveTodo} schema={todoSchema} className="needs-validation mx-3 mb-3">
									<Row>
										<Col>
											<TextInput type="text" name="newTodo" className="form-control" placeholder="Add new todo" key="newTodo" />
										</Col>
										<Col className="col-auto">

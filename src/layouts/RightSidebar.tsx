...
const RightSideBar = () => {
	...
	return (
		<>
			<Offcanvas show={isOpenRightSideBar} onHide={handleRightSideBar} placement="end" id="theme-settings-offcanvas">
				...
				<div className="offcanvas-footer border-top p-3 text-center">
					<Row>
						<div className="col-6">
							<button type="button" className="btn btn-light w-100" id="reset-layout" onClick={reset}>
								Reset
							</button>
						</div>
						<div className="col-6">

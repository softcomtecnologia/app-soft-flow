	...
	return (
		<Dropdown show={isOpen} onToggle={toggleDropdown}>
			<Dropdown.Toggle variant="link" id="dropdown-languages" onClick={toggleDropdown} className="nav-link dropdown-toggle arrow-none">
				<Image src={enLang.flag} alt={enLang.name} className="me-0 me-sm-1" height="12" />
			...
			<Dropdown.Menu align={'end'} className="dropdown-menu-animated topbar-dropdown-menu">
				<div onClick={toggleDropdown}>
					{Languages.map((lang, i) => {
						return (
							<Link href="" className="dropdown-item notify-item" key={i + '-lang'}>
								<Image src={lang.flag} alt={lang.name} className="me-1" height="12" />

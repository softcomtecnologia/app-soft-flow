...
const optionGetter = (option: SearchOption) => {
	switch (option.type) {
		case 'report':
			return (
				<Link href="" className={classNames('dropdown-item', 'notify-item', 'p-0')}>
		...
		case 'users':
			return (
				<Link href="" className="dropdown-item notify-item p-0">
					<div className="d-flex">
						{option.userDetails?.avatar && <Image src={option.userDetails.avatar} alt="" className="d-flex me-2 rounded-circle" height="32" />}
						<div className="w-100">
